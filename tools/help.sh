...
case "$fn" in
    "list"|"help")
        ...
        echo "mac g.wipe     : Wipe all history and keep current status"
        echo "mac g.clean    : Clean untracked files in .gitignore"
        echo "mac g.push     : Push to current branch"
        echo "mac g.pull     : Pull to current branch"
        echo "mac g.merge    : Merge a specific branch"
        echo "mac g.rebase   : Git Rebase"
        ...
        echo "mac g.stash    : Make a stash, stay away from dirty work tree"
        echo "mac g.unstash  : Get out from stash (EVERY CHANGES IN THERE COUNTS)"
        ...
        echo "    (olgo)"
        echo "pymake         : Add one template Python Makefile in current folder"
